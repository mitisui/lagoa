...
import net.mitisui.lagoa.mecanicas.pistola.PistolaEvents;
import net.mitisui.lagoa.mecanicas.espadas.SwordEvents;
...
public class Lagoa {
    ...
    public Lagoa(IEventBus modEventBus, ModContainer modContainer) {
        ...
        NeoForge.EVENT_BUS.register(SwordEvents.class);
        NeoForge.EVENT_BUS.register(GlobalEvents.class);
        NeoForge.EVENT_BUS.register(PistolaEvents.class);
